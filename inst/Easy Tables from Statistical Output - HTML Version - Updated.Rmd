...
```{r coefficients-standard-errors-lm1}

summary(lm1)$coefficients
class(summary(lm1)$coefficients)

```

You can now use these values in text:

```{r use-values-in-text}

# The estimated effect of X1 is: `r round(summary(lm1)$coefficients[2,1],2)`; 
# standard error is: `r round(summary(lm1)$coefficients[2,2],2)`.
