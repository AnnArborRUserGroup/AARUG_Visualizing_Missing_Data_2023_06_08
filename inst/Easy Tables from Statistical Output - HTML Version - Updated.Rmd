...
class(summary_coefficients$coefficients)
...
# The estimated effect of X1 is: `r round(summary(summary_coefficients$coefficients[2,1],2)`; 
# standard error is: `r round(summary_coefficients$coefficients[2,2],2)`.
